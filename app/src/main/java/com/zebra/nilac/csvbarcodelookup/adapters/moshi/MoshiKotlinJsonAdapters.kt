package com.zebra.nilac.csvbarcodelookup.adapters.moshi
 ...
 */
internal class MoshiKotlinJsonAdapters<T>(
...
class MoshiKotlinJsonAdaptersFactory : JsonAdapter.Factory {
    override fun create(type: Type, annotations: MutableSet<out Annotation>, moshi: Moshi)
        ...
        val bindingsByName = LinkedHashMap<String, MoshiKotlinJsonAdapters.Binding<Any, Any?>>()
        ...
        for (property in rawTypeKotlin.memberProperties) {
            ...
            bindingsByName[property.name] =
                MoshiKotlinJsonAdapters.Binding(
                    name, adapter,
                    property as KProperty1<Any, Any?>, parameter
                )
        }

        val bindings = ArrayList<MoshiKotlinJsonAdapters.Binding<Any, Any?>?>()
        ...
        return MoshiKotlinJsonAdapters(
            constructor,
            bindings,
            options
        ).nullSafe()
